...
public class Tech implements Initializable {
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        video1.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                AnchorPane pane=null;
                try{
                    pane=FXMLLoader.load(getClass().getResource("techvideo.fxml"));
                }catch (IOException e) {
                    e.printStackTrace();
                }
        ...
        reading.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                AnchorPane pane=null;
                try{
                    pane=FXMLLoader.load(getClass().getResource("techreading.fxml"));
                }catch (IOException e) {
                    e.printStackTrace();
                }
