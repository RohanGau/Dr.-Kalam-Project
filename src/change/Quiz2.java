...
public class Quiz2 implements Initializable {
    ...
    void backtocategory(ActionEvent event) {
        ...
        try{
            pane=FXMLLoader.load(getClass().getResource("changing.fxml"));
        }catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        video.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                AnchorPane pane=null;
                try {
                    pane = FXMLLoader.load(getClass().getResource("quiz2video.fxml"));
                } catch (IOException e) {
                    e.printStackTrace();
                }
        ...
        read.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                AnchorPane pane=null;
                try {
                    pane = FXMLLoader.load(getClass().getResource("quiz2read.fxml"));
                } catch (IOException e) {
                    e.printStackTrace();
                }
                Stage stge = (Stage) read.getScene().getWindow();
                stge.setScene(new Scene(pane));
                stge.show();
        ...
        reading.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent event) {
                ...
                Stage stge = (Stage) reading.getScene().getWindow();
                stge.setScene(new Scene(pane));
                stge.show();
